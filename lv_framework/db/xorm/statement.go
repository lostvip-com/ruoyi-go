...
// Incr Generate  "Updates ... Set column = column + arg" statement
...
// Decr Generate  "Updates ... Set column = column - arg" statement
...
// SetExpr Generate  "Updates ... Set column = {expression}" statement
...
// Nullable Updates use only: update columns to null when value is nullable and zero-value

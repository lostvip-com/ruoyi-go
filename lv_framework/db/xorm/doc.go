...
1. AddSave one or multiple records to database

	affected, err := engine.AddSave(&struct)
	// INSERT INTO struct () values ()
	affected, err := engine.AddSave(&struct1, &struct2)
	// INSERT INTO struct1 () values ()
	// INSERT INTO struct2 () values ()
	affected, err := engine.AddSave(&sliceOfStruct)
	// INSERT INTO struct () values (),(),()
	affected, err := engine.AddSave(&struct1, &sliceOfStruct2)
	// INSERT INTO struct1 () values ()
	// INSERT INTO struct2 () values (),(),()
...
5. Updates one or more records

	affected, err := engine.ID(...).Updates(&user)
	// UPDATE user SET ...

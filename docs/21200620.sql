...
-- ----------------------------
INSERT INTO `gen_table` VALUES ('5', 'sys_config', '参数配置表', 'config', 'crud', 'yj-app', 'modules', 'config', '参数配置', 'yunjie', '', 'admin', '2020-03-26 20:35:17', 'admin', '2020-03-27 09:49:22', '455445454');

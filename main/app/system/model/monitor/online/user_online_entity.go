...
type UserOnline struct {
	SessionId      string    `gorm:"type:int(11);primary_key;参数主键;" json:"sessionId"`
	...
	StartTimestamp time.Time `gorm:"type:datetime;comment:创建时间;column:create_time;" json:"start_timestamp" time_format:"2006-01-02 15:04:05"`
	LastAccessTime time.Time `gorm:"type:datetime;comment:创建时间;column:create_time;" json:"last_access_time" time_format:"2006-01-02 15:04:05"`
	ExpireTime     int       `gorm:"type:varchar(30);" json:"expire_time"`
}
